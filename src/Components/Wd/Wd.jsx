  ...
  return isLoading ? (
    ...
    <div className="grid lg:grid-cols-1 xl:grid-cols-2  gap-10 justify-items-center container mx-auto my-12">
      {data?.data?.map((wd) => (
              ...
              <div key={wd._id} className="card lg:w-[600px] w-[90vw] card-side bg-base-100 duration-300 border tracking-wide font-medium border-main hover:shadow-[0_0_40px_#D1D1D1] shadow-[0_0_40px_#D1D1D1]">
