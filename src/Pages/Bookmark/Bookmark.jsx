...
const Bookmark = () => {
  ...
  return (
    <div>
      <h3 className="text-center font-semibold text-3xl my-16 text-main">
      ...
      <div className="grid lg:grid-cols-2  gap-10 justify-items-center container mx-auto my-12">
        {Bookmark?.map((item) => (
          <div
            key={item._id}
            className="lg:w-[600px] w-[90vw]  duration-300 border tracking-wide font-medium shadow-[0_0_40px_#D1D1D1] relative pb-12"
          >
